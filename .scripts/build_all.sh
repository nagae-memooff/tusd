...
function compile {
  ...
  GOOS=$os GOARCH=$arch go build \
    -ldflags="-X github.com/nagae-memooff/tusd/cmd/tusd/cli.VersionName=${version} -X github.com/nagae-memooff/tusd/cmd/tusd/cli.GitCommit=${commit} -X 'github.com/nagae-memooff/tusd/cmd/tusd/cli.BuildDate=$(date --utc)'" \
...
function makedep {
  ...
  echo "Homepage: https://github.com/nagae-memooff/tusd" >> "./$dir/DEBIAN/control"
